                ...
                if piece_arrivee==None:
                    ...
                    if piece.getcouleur()==piece_arrivee.getcouleur():
                        ...
                        if piece and piece.mouvement_valide(depart, arrivee, piece_arrivee, plateau):
                            ...
                            self.plateau[depart[0]][depart[1]] = None
                            self.turn = self.turn+1
                            #transformation => EN COURS DE DEV
                            if piece.getcouleur()=='blanc' and arrivee[0]==7 and piece.getType_piece()=='pion':
                                transformation = 'ok'
                                while transformation != 'Reine' or 'Cavalier' or 'Fou' or 'Tour':
                                    transformation = input('En quel piece voulez vous transformer votre pion (ex: Reine, Cavalier, etc)')
                                    if transformation == 'Reine' :
                                        print("reine")
                                        piece = Reine('blanc')
                                        print(piece.getType_piece())
                                        break
...
if __name__ == "__main__":
    ...
    while flag==True:
        ...
        '''
                            #transformation => EN COURS DE DEV
                        if piece_arrivee.getcouleur()=='blanc' and arrivee[0]==7 and piece_arrivee.getType_piece()=='pion':
                            transformation = 'ok'
                            while transformation != 'Reine' or 'Cavalier' or 'Fou' or 'Tour':
                                transformation = input('En quel piece voulez vous transformer votre pion (ex: Reine, Cavalier, etc) ')
                                if transformation == 'Reine' :
                                    print('pas de reine')
                                    piece_arrivee = Reine('blanc')
                                    break
                                elif transformation == 'Cavalier':
                                    print('pas de cavabelier')
                                    piece_arrivee = Cavalier('blanc')
                                    break
                                elif transformation == 'Fou':
                                    print('sale fou va')
                                    piece_arrivee = Fou('blanc')
                                    break
                                elif transformation == 'Tour':
                                    print("t'es consstruit en paille ouuuuuu")
                                    piece_arrivee = Tour('blanc')
                                    break
                                else:
                                    print("cette transformation n'est pas valide")
'''